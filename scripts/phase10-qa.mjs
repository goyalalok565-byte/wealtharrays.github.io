...
const cases = [
  ...
  ['fixed-deposit', { principal: 1000, rate: 10, years: 1, inflation: 0, freq: '1' }, 'Maturity value (future money)', 1100],
  ['recurring-deposit', { monthly: 100, rate: 0, years: 1, inflation: 0 }, 'Total deposits', 1200],
  ['lumpsum', { principal: 1000, rate: 10, years: 2, inflation: 0 }, 'Projected value (future money)', 1210],
  ['cagr', { start: 1000, end: 1210, years: 2 }, 'CAGR', 10],
