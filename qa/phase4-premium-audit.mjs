...
if(!widgetSource.includes('new URL(`/widget.html?calc=${encodeURIComponent(calc.id)}`,document.baseURI).href')) failures.push('widget.js: embed URL must use the root /widget route');
