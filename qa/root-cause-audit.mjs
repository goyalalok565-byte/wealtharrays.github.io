...
if(!home.includes('id="tool-search-results"'))throw new Error('Homepage search results container missing');
if(!home.includes('href="/favicon.svg"'))throw new Error('Homepage canonical favicon missing');

const styles=fs.readFileSync('styles.css','utf8');
if(!/\.search-bar\{[^}]*position:relative/i.test(styles)&&!styles.includes('.search-bar{position:relative'))throw new Error('Homepage search parent must be positioned');
