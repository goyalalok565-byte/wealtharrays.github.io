...
const enhancement=fs.readFileSync('calculator-enhancements.js','utf8');if(!/new URL\('\/icon-512\.png',(?:window\.location|location)\.origin\)\.href/.test(enhancement))throw new Error('PDF export must use current icon-512.png');if(!enhancement.includes('id="wa-pdf-logo"'))throw new Error('PDF report logo element missing');
