...
const runtimeSources = ['wa-core.js','site-runtime.js','final-polish.js','wa-enhancements.js','theme-fix.js','phase2-intelligence.js','phase2-retirement.js','phase3-seo.js','calculator-page-init.js','phase4-premium.js','calculators.js','widget.js'];
...
console.log(`Stabilization audit PASS — ${calculators.length} calculators use exactly one canonical runtime bundle; retired runtime is absent; source modules are not page-loaded directly; AdSense and ads.txt contracts preserved.`);
