...
const expectedCspWarning = text => /^\[Report Only\]/i.test(text) || /Refused to execute inline script because it violates the following Content Security Policy directive/i.test(text);
